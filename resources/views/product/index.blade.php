...
<div class="container">
		...
		<div class="col-xl-12">
			...
			<form action="{{ route('product.index') }}" method="GET">
				...
				<div class="flex-column">
						...
						<!-- Price -->
					<div class="flex-row">
						<div class="sidebar-widget flex-1 margin-right-10">
    ...
    <!-- Accordion Item / End -->
			...
			<div class="sidebar-container">
				...
				<!-- Location -->
				<!-- Tags -->
				<div class="sidebar-widget flex-0-0-33">
					<h3>Tags</h3>
                ...
                </div>	<div class="col-xl-12 padding-right-0 padding-left-0">
                        ...
                        <div class="company">
                            ...
                            <div class="company-inner-alignment">
                                ...
                                <div class="star-rating" data-rating="99.5"></div>
                                    ...
                                    <a href="#" class="buy_now">Pirkti dabar</a>
                            </div>
                        </div>
                    @empty
